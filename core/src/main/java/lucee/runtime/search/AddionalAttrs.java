...
public final class AddionalAttrs {
	...
	private int contextPassageLength;
	private String contextHighlightEnd;
	private int startrow = 1;
	private int maxrows = -1;
	private boolean hasRowHandling;

	public AddionalAttrs(int contextBytes, int contextPassages, int contextPassageLength, String contextHighlightBegin, String contextHighlightEnd) {
		this.contextBytes = contextBytes;
		this.contextPassages = contextPassages;
		this.contextPassageLength = contextPassageLength;
	...
	public static AddionalAttrs getAddionlAttrs() {
		...
		if (aa == null) aa = new AddionalAttrs(300, 0, 150, "<b>", "</b>");
		return aa;
	}
	...
	public static void setAddionalAttrs(int contextBytes, int contextPassages, int contextPassageLength, String contextHighlightBegin, String contextHighlightEnd) {
		setAddionalAttrs(new AddionalAttrs(contextBytes, contextPassages, contextPassageLength, contextHighlightBegin, contextHighlightEnd));
	}
	...
	/**
	 * @return the contextPassageLength
	 */
	public int getContextPassageLength() {
		return contextPassageLength;
	}
