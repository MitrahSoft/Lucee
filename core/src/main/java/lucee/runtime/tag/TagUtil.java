...
public final class TagUtil {
	...
	public static void setAttributeCollection(PageContext pc, Object tag, MissingAttribute[] missingAttrs, Struct _attrs, int attrType) throws PageException {
	...
	public static void setAppendix(Tag tag, String appendix) throws PageException { // used by generated bytecode
		// if (tag instanceof TagPro) ((TagPro) tag).setAppendix(appendix);
